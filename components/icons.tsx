...
export const Icons = {
  logo: (props: IconProps) => (
    ...
    >
      <circle cx='256' cy='256' r='256' fill='url(#paint0_radial_0_1)' />
      <g filter='url(#filter0_d_0_1)'>
        <path
          d='M254.841 179.227C247.265 179.322 239.642 181.263 231.972 185.051C224.396 188.839 218.051 193.858 212.938 200.108C207.919 206.263 205.409 213.129 205.409 220.705H172.455C172.455 211.235 174.727 202.144 179.273 193.432C183.818 184.72 189.926 176.955 197.597 170.136C205.362 163.318 214.169 157.92 224.017 153.943C233.96 149.966 244.235 147.977 254.841 147.977C274.727 147.977 291.583 152.996 305.409 163.034C319.33 173.072 329.888 186.33 337.085 202.807C344.377 219.284 348.023 237.182 348.023 256.5V264.455C348.023 283.678 344.377 301.576 337.085 318.148C329.888 334.625 319.33 347.883 305.409 357.92C291.583 367.958 274.727 372.977 254.841 372.977C238.932 372.977 224.775 369.473 212.369 362.466C199.964 355.364 190.21 345.894 183.108 334.057C176.006 322.22 172.455 309.057 172.455 294.568H205.409C205.409 302.807 207.729 310.525 212.369 317.722C217.104 324.824 223.212 330.6 230.693 335.051C238.269 339.407 246.318 341.633 254.841 341.727C267.53 341.633 278.326 337.655 287.227 329.795C296.129 321.936 302.9 312.087 307.54 300.25C312.18 288.413 314.5 276.481 314.5 264.455V256.5C314.5 244.189 312.18 232.163 307.54 220.42C302.994 208.583 296.271 198.782 287.369 191.017C278.563 183.252 267.72 179.322 254.841 179.227ZM328.136 243.432V274.682H232.682V243.432H328.136Z'
          fill='white'
        />
      </g>
      <defs>
  ...
  menu: (props: IconProps) => (
    <svg
      ...
      xmlns='http://www.w3.org/2000/svg'
    >
      <circle cx='256' cy='256' r='256' fill='url(#logo1_paint0_radial)' />
      <g opacity='0.98' filter='url(#logo1_filter0_d)'>
        <line
          x1='126'
          y1='168.5'
          x2='386'
      ...
      <g opacity='0.98' filter='url(#logo1_filter1_d)'>
        <line
          x1='126'
          y1='340.5'
          x2='386'
      ...
      <g opacity='0.98' filter='url(#logo1_filter2_d)'>
        <line
          x1='126'
          y1='254.5'
          x2='386'
  ...
  russie: (props: IconProps) => (
    <svg {...props} viewBox='0 0 64 64' xmlns='http://www.w3.org/2000/svg'>
      <path
        d='m31.9 2c-13 0-24.1 8.4-28.2 20h56.6c-4.2-11.6-15.3-20-28.4-20z'
        fill='#f9f9f9'
      />
      <path
        d='m31.9 62c13.1 0 24.2-8.4 28.3-20h-56.5c4.1 11.7 15.2 20 28.2 20z'
        fill='#ed4c5c'
      />
      <path
        d='m3.7 22c-1.1 3.1-1.7 6.5-1.7 10s.6 6.9 1.7 10h56.6c1.1-3.1 1.7-6.5 1.7-10s-.6-6.9-1.7-10z'
        fill='#428bc1'
      />
    </svg>
  ),
